...
import static com.msb.bpm.approval.appr.enums.email.EventCodeEmailType.APPROVER_RETURN;
...
@Component
@Slf4j
public class ApproverReturnSenderStrategy extends AbstractBaseService implements SenderStrategy {
  ...
  public void publishEmail(String eventCode) {
    ...
    EmailRequest dataSend = EmailRequest.builder()
        ...
        .eventCode(APPROVER_RETURN.name())
        .params(params)
        .build();
