...
@Component
@Slf4j
public class LdpSendFeedbackCustomerSenderStrategy extends AbstractBaseService implements
    SenderStrategy {
  private ConcurrentMap<String, Object> metadata;
  @Override
  public EventCodeEmailType getType() {
    return LDP_SEND_FEEDBACK_CUSTOMER;
  }
  @Override
