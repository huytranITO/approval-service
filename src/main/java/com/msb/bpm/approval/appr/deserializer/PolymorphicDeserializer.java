...
import com.msb.bpm.approval.appr.spi.SubType;
import com.msb.bpm.approval.appr.spi.SubTypes;
import com.msb.bpm.approval.appr.spi.TypeInfo;
...
public class PolymorphicDeserializer extends JsonDeserializer<Object> implements
  ...
  private Class<?> resolveConcreteType(final Class<?> current,
      UnaryOperator<String> fieldValueExtractor) {
