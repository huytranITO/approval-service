...
@JsonTypeInfo(use = JsonTypeInfo.Id.NAME, visible = true, include = JsonTypeInfo.As.EXISTING_PROPERTY
    , property = CUSTOMER_TYPE, defaultImpl = CmsIndividualCustomerDTO.class)
@JsonSubTypes({
    @JsonSubTypes.Type(value = CmsIndividualCustomerDTO.class, name = RB),
    @JsonSubTypes.Type(value = CmsEnterpriseCustomerDTO.class, name = EB)
})
...
public abstract class CmsCustomerDTO implements Serializable {
