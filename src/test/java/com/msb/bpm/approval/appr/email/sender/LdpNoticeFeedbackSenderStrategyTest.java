...
public class LdpNoticeFeedbackSenderStrategyTest extends TestCase {
  @Mock
  ...
  @InjectMocks
  LdpNoticeFeedbackSenderStrategy ldpNoticeFeedbackSenderStrategy;
  ...
  public void testGetType() {
    Assert.assertEquals(LDP_NOTICE_FEEDBACK, ldpNoticeFeedbackSenderStrategy.getType());
  }
  ...
  public void testPublishEmail() {
    ...
    ldpNoticeFeedbackSenderStrategy.setMetadata(metadata);

    String eventCode = "LDP_NOTICE_FEEDBACK";
    ...
    when(abstractBaseService.getPreviousHistoryApprovalByRole(new ArrayList<>(entityApp.getHistoryApprovals()), ProcessingRole.PD_RB_BM)).thenReturn(Collections.emptyList());
    ...
    // Act
    ldpNoticeFeedbackSenderStrategy.publishEmail(eventCode);
